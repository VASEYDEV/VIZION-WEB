...
/// Dependency-free SHA-256 (FIPS 180-4). CryptoKit is Apple-only and the core
/// package must test on Linux; the content hash is a few hundred bytes at
/// most, so speed is irrelevant.
public enum SHA256 {
